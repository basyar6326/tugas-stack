...
void push(string nama,string posisi)
{
     if(isfull() == true) /*panggil fungsi isempty(), jika kondisi benar pernyataan dijalankan*/
      {
            ...
            stackbaru.top++;
            stackbaru.nama[stackbaru.top]=nama;
            stackbaru.posisi[stackbaru.top]=posisi;
      }
}
...
void pop()
{
      ...
      {
            cout<<"Data yang terambil : " <<stackbaru.nama[stackbaru.top]<<","<<stackbaru.posisi[stackbaru.top];
            stackbaru.top--;
      }
}
...
void print()
{
      ...
      {
            cout<<stackbaru.nama[i]<<","<<stackbaru.posisi[i]<<"    ";
      }
}
...
int main()
{
      ...
      do
      {
            ...
            else if(menu == '2')
            {
                  cout<<"\nTambah Data";
                  cout<<"\n-----------";
                  cout<<"\nData yang akan disimpan di stack : "<<endl;
                  cout << "nama:";
                  cin >> nama;
                  cout << "posisi:";
                  cin >> posisi;
                 push(nama,posisi); /*panggil fungsi push(dta)--dta sesuai dengan data ynag diinput*/
                  ulang = 'y';
            }
            else if(menu == '3')
            {
